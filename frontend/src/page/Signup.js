...
import loginSignImage from "../Image/signup.gif";
    ...
    <div className='p-3 md:p-4'>
      <div className='w-full max-w-sm bg-white m-auto flex flex-col p-4'>
        ...
        <form className='w-full py-3 flex flex-col' onSubmit={handleSubmit}>
          ...
          <div className='flex px-2 py-1 mt-1 mb-2 bg-slate-200 rounded focus-within:outline rounded focus-within:outline-blue-300 '>
            <input
